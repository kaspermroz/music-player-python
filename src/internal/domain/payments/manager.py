...
class PaymentsManager:
    """
    Manager for handling of all payments in application.
    Is responsible for accumulating sum of all inserted coins
    and credit generated by playbacks.
    Provides convenient interface for GUI to display payments information.
    """
    currency: Currency
